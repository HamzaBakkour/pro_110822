...
_TESTS_TIMEOUT_ = [{'test_name': 'test_accept_connection',
                    'timeout': 3},
                    {'test_name': 'test_info_requset',
                    'timeout': 3},
                    {'test_name': 'test_broadcast',
                    'timeout': 20},
                    {'test_name': 'test_connections_monitor',
                    'timeout': 10},
                    {'test_name': 'test_shortcut_handler',
                    'timeout': 7},
